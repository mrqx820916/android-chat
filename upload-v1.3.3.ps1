...
Write-Host "上传 APK..."
aws --endpoint-url https://cn-nb1.rains3.com s3 cp "dist\update\release\lightchat-v1.3.3-16-d7669ab7.apk" s3://xzd/chat/release/
...
Write-Host "验证上传..."
aws --endpoint-url https://cn-nb1.rains3.com s3 ls s3://xzd/chat/release/ --last 5
